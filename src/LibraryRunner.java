                ...
                switch (adminOperations) {
                    ...
                    case "3":
                        ...
                        if (selectedBook2 != null && (updatedBook == null || updatedBook.getId() == selectedBook2.getId())) {
                            ...
                            String categoryResult = scanner5.nextLine();
                            switch (categoryResult) {
                                case "1" -> updatedBook = new Book(Integer.parseInt(addedId2), addName2, author2, Categories.SPORT);
                                case "2" -> updatedBook = new Book(Integer.parseInt(addedId2), addName2, author2, Categories.CLASSICS);
                                case "3" -> updatedBook = new Book(Integer.parseInt(addedId2), addName2, author2, Categories.HISTORY);
                                case "4" -> updatedBook = new Book(Integer.parseInt(addedId2), addName2, author2, Categories.TECHNOLOGY);
                                default -> System.out.println("You entered an invalid category");
                            }
                            if (updatedBook != null) {
